			...
			<form action="" onsubmit= "return validate()" method = "post">
				<table style="border-color:green; width:40%; height:50%;" align="center" border="4">
					...
					<tr>
					   ...
					   <br><span id="err_Branch">&nbsp; <br><?php echo $err_Branch; ?></span>
				       </td>
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_NID">&nbsp; <br><?php echo $err_NID; ?></span>
						</td>		
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_Address">&nbsp; <br><?php echo $err_Address; ?></span>
						</td>		
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_Email">&nbsp; <br><?php echo $err_Email; ?></span>
						</td>		
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_Phone">&nbsp; <br><?php echo $err_Phone; ?></span>
						</td>		
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_CIT">&nbsp; <br><?php echo $err_CIT; ?></span>
						</td>		
					</tr>
					...
					<tr>
					  ...
					  <br><span id="err_COT">&nbsp; <br><?php echo $err_COT; ?></span>
						</td>	
					</tr>
